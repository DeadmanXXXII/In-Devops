...
grammar_checker = language_check.LanguageTool('en-US')
...
def browse_file():
    ...
    if filename:
        with open(filename, 'r') as file:
            text_to_analyze_str.set(file.read())

# Example usage:
text_to_analyze_str = tk.StringVar()
text_to_analyze_str.set("This is a sample text for word count analysis.")
...
autocorrect_button.pack(padx=20, pady=5)
